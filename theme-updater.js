...
const replacements = [
  ...
  ['aspect-square', 'aspect-4-5'], // Change image aspect ratio 
];
...
function processFile(filePath) {
  ...
  // We should be careful about replacing strings that might be part of other words, 
  // but utility classes are usually space-separated or quote-bounded
  for (let [oldClass, newClass] of replacements) {
    // Replace with word boundaries or matching surrounding quotes/spaces
    // simplistic replace all for tailwind classes:
