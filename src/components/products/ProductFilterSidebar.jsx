...
const ProductFilterSidebar = ({
  ...
  return (
    <aside
      className={`
      lg:block lg:w-[19rem] xl:w-[20.5rem] flex-shrink-0 lg:sticky lg:z-30 transition-all duration-700 ${headerVisible ? "lg:top-[12.5rem]" : "lg:top-[11rem]"} h-fit
      ${
        showFilters
          ? "fixed inset-0 z-[90] bg-black/45 backdrop-blur-[2px] lg:relative lg:z-30 lg:bg-transparent lg:backdrop-blur-none"
          : "hidden"
      }
    `}
    >
              ...
              {expandedSections.price && (
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-xs text-gray-500">
                    <span>
                      {formatInrWithSymbol(0, { maximumFractionDigits: 0 })}
                    </span>
                    <span>
