...
const Seo = ({
  ...
  useEffect(() => {
    ...
    upsertMeta('meta[property="og:site_name"]', { property: "og:site_name", content: "Zoop" });
    ...
    upsertScript("zoop-jsonld", jsonLd);

    return () => {
      const currentScript = document.getElementById("zoop-jsonld");
      if (currentScript) currentScript.remove();
    };
  }, [title, description, image, keywords, robots, canonicalPath, jsonLd, location.pathname, location.search, type]);
