...
export const ProductCardSkeleton = () => {
  return (
    <div className="bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm p-3">
      <div className="aspect-square bg-gray-200 rounded-xl mb-3 animate-pulse relative">
...
export const PageSkeleton = () => {
  return (
    <div className="min-h-screen bg-gray-50 p-6 max-w-[1600px] mx-auto">
