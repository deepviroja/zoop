    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mx-auto max-w-[1600px] space-y-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <h1 className="text-3xl font-black text-zoop-obsidian">Orders</h1>
          ...
          <div className="grid w-full max-w-3xl grid-cols-2 gap-3 md:grid-cols-4">
            <div className="rounded-2xl bg-white p-4 shadow-sm">
              ...
              <p className="mt-2 text-2xl font-black text-zoop-obsidian">{orderStats.total}</p>
            </div>
            <div className="rounded-2xl bg-white p-4 shadow-sm">
        ...
        <div className="rounded-3xl border border-gray-100 bg-white p-5 shadow-sm">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <input
              ...
              className="w-full rounded-xl border border-gray-200 px-4 py-3 lg:max-w-md"
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {filteredOrders.map((order) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-sm text-gray-600">
                          {(order.sellerSummaries || []).length > 0 ? (
                            order.sellerSummaries.slice(0, 2).map((seller) => (
                              <p key={seller.id} className="font-bold text-zoop-obsidian">
                        ...
                        <td className="px-6 py-4 font-black text-zoop-obsidian">
              ...
              <div className="space-y-6">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <h2 className="mt-2 text-2xl font-black text-zoop-obsidian">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="rounded-2xl bg-gray-50 p-4">
                    ...
                    <p className="mt-2 font-black text-zoop-obsidian">
