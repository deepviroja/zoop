...
const Skeleton = ({ className = "" }) => (
  <div
    className={`bg-gray-200 dark:bg-white/20 animate-pulse rounded-xl ${className}`}
  />
);
            ...
            {displayLocalProducts.map((product) => (
              ...
              >
                ...
                <div className="flex justify-between items-center mt-3">
                  ...
                  <span className="px-3 py-1.5 text-[10px] rounded-full bg-zoop-moss/30 font-bold hover:bg-zoop-obsidian hover:text-white transition-colors uppercase">
                    View
                  </span>
                </div>
              </Link>
                ...
                >
                  <div className="h-20 w-full rounded-2xl overflow-hidden bg-[#f4efe6] dark:bg-white/5 flex items-center justify-center">
                    {brand.image ? (
                      ...
                      <span className="font-black text-lg text-zoop-obsidian dark:text-white">
                        {brand.name}
                      </span>
                    )}
                  </div>
                  <p className="mt-4 font-black text-zoop-obsidian dark:text-white">
                    {brand.name}
                  </p>
              ...
              <>
                ...
                <div className="hidden md:grid bento-grid mt-4">
                  {collectionCategories.map((cat, idx) => {
                    ...
                    if (idx === 0)
                      spanClass =
                        "col-span-12 md:col-span-6 md:row-span-2 bento-item min-h-[38rem]";
                    else if (idx === 1 || idx === 2)
                      spanClass =
                        "col-span-12 md:col-span-3 md:row-span-1 bento-item min-h-[18rem]";
                    else if (idx === 3)
                      spanClass =
                        "col-span-12 md:col-span-6 md:row-span-1 bento-item min-h-[18rem]";
                    else
                      spanClass =
                        "col-span-12 md:col-span-3 bento-item min-h-[18rem]";
              ...
              <div className="relative z-20 h-full flex flex-col justify-end p-8 md:p-10">
                ...
                <div
                  className={`inline-flex items-center gap-2 px-6 py-3 rounded-full font-black text-sm uppercase tracking-wider hover:scale-105 transition-all duration-300 w-fit ${
                    idx === 0
                      ? "bg-white/95 dark:bg-white/10 text-slate-900 dark:text-white hover:bg-zoop-moss hover:text-zoop-obsidian"
                      : "bg-rose-950 text-white dark:bg-white/10 dark:text-white hover:bg-zoop-moss hover:text-zoop-obsidian"
                  }`}
                >
