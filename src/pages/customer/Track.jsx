      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-zoop-moss rounded-full mb-4">
            <Package width={40} height={40} className="text-zoop-obsidian dark:text-white" />
          </div>
          <h1 className="text-4xl font-black text-zoop-obsidian dark:text-white mb-2">Track Your Order</h1>
          <p className="text-gray-600 dark:text-gray-400">Enter your tracking ID to see real-time updates</p>
        </div>

        {/* Tracking Form */}
        <div className="bg-white dark:glass-card rounded-2xl shadow-lg dark:shadow-[0_12px_32px_rgba(0,0,0,0.5)] p-8 mb-8">
          <form onSubmit={handleTrack} className="flex gap-4">
            <input
              ...
              className="flex-1 px-6 py-4 border-2 border-gray-200 dark:border-white/10 rounded-xl text-lg focus:outline-none focus:border-zoop-moss transition-colors"
            />
            <button
              type="submit"
              disabled={loading}
        ...
        {/* Tracking Results */}
        {trackingResult && (
          <div className="bg-white dark:glass-card rounded-2xl shadow-lg dark:shadow-[0_12px_32px_rgba(0,0,0,0.5)] p-8">
            {/* Status Header */}
            <div className="flex items-center justify-between mb-8 pb-6 border-b border-gray-200 dark:border-white/10">
              <div>
                ...
                <p className="text-2xl font-black text-zoop-obsidian dark:text-white">{trackingResult.id}</p>
              </div>
            ...
            <div className="bg-gradient-to-r from-zoop-moss/10 to-transparent rounded-xl p-6 mb-8">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-zoop-moss rounded-full flex items-center justify-center">
                  <Truck width={24} height={24} className="text-zoop-obsidian dark:text-white" />
                </div>
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Current Status</p>
                  <p className="text-2xl font-black text-zoop-obsidian dark:text-white">{trackingResult.status}</p>
            ...
            <div className="space-y-6">
              <h3 className="text-lg font-black text-zoop-obsidian dark:text-white uppercase tracking-wider mb-6">
                Tracking Timeline
              </h3>
              {trackingResult.timeline.map((item, index) => (
                <div key={index} className="flex gap-4">
                  ...
                  <div className="relative">
                    ...
                    >
                      {item.completed ? (
                        <CheckCircle width={20} height={20} className="text-zoop-obsidian dark:text-white" />
                      ) : (
                    ...
                    {index < trackingResult.timeline.length - 1 && (
                      <div
                        className={`absolute left-1/2 top-10 w-0.5 h-12 -translate-x-1/2 ${
                          item.completed ? 'bg-zoop-moss' : 'bg-gray-200 dark:bg-white/20'
                        }`}
                      />
                    )}
                  </div>
                  ...
                  <div className="flex-1 pb-8">
                    <p
                      className={`font-bold ${
                        item.current ? 'text-zoop-obsidian dark:text-white text-lg' : 'text-gray-700 dark:text-gray-300'
                      }`}
                    >
                      {item.status}
                    </p>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 dark:border-white/10">
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="px-6 py-3 border-2 border-gray-200 dark:border-white/10 rounded-xl font-bold hover:border-zoop-moss transition-colors"
                >
                  Contact Support
                </button>
                <Link
                  to="/history"
                  className="px-6 py-3 bg-gray-100 dark:bg-white/10 rounded-xl font-bold hover:bg-gray-200 transition-colors"
                >
                  View Order Details
                </Link>
              </div>
        ...
        {!trackingResult && (
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white dark:glass-card rounded-xl p-6 text-center">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Package width={24} height={24} className="text-blue-600" />
              </div>
              <h3 className="font-bold text-zoop-obsidian dark:text-white mb-2">Real-Time Updates</h3>
            ...
            <div className="bg-white dark:glass-card rounded-xl p-6 text-center">
              ...
              <h3 className="font-bold text-zoop-obsidian dark:text-white mb-2">Fast Delivery</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="bg-white dark:glass-card rounded-xl p-6 text-center">
              ...
              <h3 className="font-bold text-zoop-obsidian dark:text-white mb-2">Secure Delivery</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
