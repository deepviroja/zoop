  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-3xl border border-gray-100 p-6 md:p-8 space-y-4 shadow-sm">
          {points.map((item, idx) => (
            <div key={item.title} className="p-4 rounded-xl bg-gray-50 border border-gray-100">
              ...
              <h3 className="text-lg font-black text-zoop-obsidian">{item.title}</h3>
